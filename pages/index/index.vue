...
<template>
  <div class="h-full flex flex-1 overflow-x-hidden">
    ...
    />
    <!-- 空白 -->
    <div v-else-if="!setting.isMobileSize" data-fades class="h-full w-full flex flex-col items-center justify-center rounded-0 text-gray-600 sm:border-default-l card-bg-color-2 dark:(text-gray-500)">
